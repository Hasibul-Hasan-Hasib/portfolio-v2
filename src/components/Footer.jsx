    ...
    return (
        <footer className="overflow-hidden mt-auto items-center text-slate-400 border-t border-slate-500 overflow-x-auto">
            <nav className="flex place-items-center">
                ...
                <NavLink className={`${linkClasses} md:hidden border-r`} to="/about">
                    <IconBrandGithub size={24} />
                </NavLink>
                <NavLink className="hidden md:flex ml-auto px-8 py-4 border-l border-slate-500 hover:bg-slate-700 hover:text-slate-300" to="/contact">
